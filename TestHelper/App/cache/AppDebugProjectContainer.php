...
/**
 * AppDebugProjectContainer.
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class AppDebugProjectContainer extends Container
{
    private $parameters;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fixturama.faker.generator' => 'getFixturama_Faker_GeneratorService',
            'fixturama.generator' => 'getFixturama_GeneratorService',
            'fixturama.model_fixture_generator' => 'getFixturama_ModelFixtureGeneratorService',
            'fixturama.yaml.parser' => 'getFixturama_Yaml_ParserService',
    ...
    {
        return $this->services['debug.debug_handlers_listener'] = new \Symfony\Component\HttpKernel\EventListener\DebugHandlersListener(NULL, NULL, -4182, NULL, true, NULL);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), ($this->targetDirs[1].'/Resources'));
    }
    ...
    /**
     * Gets the 'fixturama.faker.generator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFixturama_Faker_GeneratorService()
    {
        return $this->services['fixturama.faker.generator'] = new \Faker\Generator();
    }

    /**
     * Gets the 'fixturama.generator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Naldz\Bundle\FixturamaBundle\Fixturama\FixtureGenerator A Naldz\Bundle\FixturamaBundle\Fixturama\FixtureGenerator instance.
     */
    protected function getFixturama_GeneratorService()
    {
        return $this->services['fixturama.generator'] = new \Naldz\Bundle\FixturamaBundle\Fixturama\FixtureGenerator(array('database' => 'test_db', 'models' => array('blog' => array('fields' => array('id' => array('type' => 'numberBetween', 'params' => array(0 => 0, 1 => 99999)), 'title' => array('type' => 'sentence', 'params' => array(0 => 10, 1 => true)), 'content' => array('type' => 'sentence'))), 'author' => array('fields' => array('id' => array('type' => 'numberBetween', 'params' => array(0 => 0, 1 => 99999)), 'name' => array('type' => 'name'))))), $this->get('fixturama.model_fixture_generator'));
    }

    /**
     * Gets the 'fixturama.model_fixture_generator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Naldz\Bundle\FixturamaBundle\Fixturama\ModelFixtureGenerator A Naldz\Bundle\FixturamaBundle\Fixturama\ModelFixtureGenerator instance.
     */
    protected function getFixturama_ModelFixtureGeneratorService()
    {
        return $this->services['fixturama.model_fixture_generator'] = new \Naldz\Bundle\FixturamaBundle\Fixturama\ModelFixtureGenerator($this->get('fixturama.faker.generator'));
    }

    /**
     * Gets the 'fixturama.yaml.parser' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFixturama_Yaml_ParserService()
    {
        return $this->services['fixturama.yaml.parser'] = new \Symfony\Component\Yaml\Parser();
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FixturamaBundle' => 'Naldz\\Bundle\\FixturamaBundle\\FixturamaBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'AppDebugProjectContainer',
            'locale' => 'en',
            ...
            'debug.container.dump' => (__DIR__.'/AppDebugProjectContainer.xml'),
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'fixturama.dsn' => 'mysql:blah',
            'fixturama.schema' => ($this->targetDirs[1].'/config/schema.yml'),
            'console.command.ids' => array(

            ),
            'fixturama.model_definition' => array(
                'database' => 'test_db',
                'models' => array(
                    'blog' => array(
                        'fields' => array(
